...
const MLPhishingDetection = () => {
  ...
  const analyzeUrl = async () => {
    ...
    try {
      const response = await fetch('http://localhost:5003/api/phishing/analyze', {
        method: 'POST',
        headers: {
      ...
      setError('Failed to connect to phishing detection service. Make sure the service is running on port 5003.');
    } finally {
